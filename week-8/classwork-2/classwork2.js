...
// Currency Converter:
// Create a currency converter program that converts an amount from one currency to another.
// Ask the user for the exchange rate and the amount in the original currency.
